...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[150vh] sm:min-h-[140vh] flex flex-col items-center py-0 md:py-40 justify-start flex-shrink-0 [perspective:800px] transform md:scale-110 scale-[0.6] sm:scale-75 -mt-20 sm:-mt-10 md:mt-0 relative"
    >
      <motion.h2
        style={{
      ...
      />
      {/* Base area */}
      <div className="h-[22rem] w-[32rem] bg-gray-200 dark:bg-neutral-800 rounded-2xl overflow-hidden relative -z-10">
        {/* above keyboard bar */}
        <div className="h-10 w-full relative">
          <div className="absolute inset-x-0 mx-auto w-[80%] h-4 bg-neutral-950" />
        </div>
        ...
        <Trackpad />
        <div className="h-2 w-20 mx-auto inset-x-0 absolute bottom-0 bg-gradient-to-t from-neutral-800 to-neutral-950 rounded-tr-3xl rounded-tl-3xl" />
        {showGradient && (
  ...
  return (
    <div className="relative [perspective:800px]">
      <div
        ...
        className="h-[12rem] w-[32rem] bg-neutral-950 rounded-2xl p-2 relative"
      >
        <div
          style={{
            boxShadow: '0px 2px 0px 2px rgb(20 20 20) inset',
          }}
          className="absolute inset-0 bg-neutral-950 rounded-lg flex items-center justify-center"
        >
      ...
      <motion.div
        ...
        className="h-96 w-[32rem] absolute inset-0 bg-neutral-950 rounded-2xl p-2"
      >
...
export const Keypad = () => {
  return (
    <div className="h-full rounded-md bg-neutral-900 mx-1 p-1">
      {/* First Row */}
      <Row>
        <KBtn
...
export const KBtn = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'h-6 w-6 bg-neutral-950 rounded-[3.5px] flex items-center justify-center',
          className
        )}
        style={{
          boxShadow:
            '0px -0.5px 2px 0 rgb(20 20 20) inset, -0.5px 0px 2px 0 rgb(20 20 20) inset',
        }}
      >
        <div
          className={cn(
...
export const SpeakerGrid = () => {
  return (
    <div
      ...
      style={{
        backgroundImage:
          'radial-gradient(circle, rgb(20 20 20) 0.5px, transparent 0.5px)',
