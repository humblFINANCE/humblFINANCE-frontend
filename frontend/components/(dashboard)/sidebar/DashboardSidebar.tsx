...
export default function DashboardSidebar({
    ...
    const [isCollapsed, setIsCollapsed] = React.useState<any>(!isMobile ? true : true)
        ...
        <div className="flex h-dvh w-full">
            <div
                ...
                >
                    ...
                    <Tooltip content="Log Out" isDisabled={!isMobile && !isCompact} placement="right">
                        <Button
            ...
            <div className="w-full flex-1 flex-col p-4">
                ...
                <main className="mt-4 h-[90%] w-full overflow-visible">
                    <div
                        className={`flex h-full w-full flex-col gap-4 rounded-medium border-small border-divider ${isMobile ? 'overflow-y-scroll' : 'overflow-hidden'} p-4`}>
                        {children}
                    </div>
                </main>
            </div>
