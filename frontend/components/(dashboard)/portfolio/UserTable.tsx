...
const UserTable = () => {
    ...
    const {watchlists, getWatchlists, refreshWatchlist, loading: loadingWatclist} = useWatchlist()
    ...
    const handleRefreshWatchlist = useCallback(async () => {
        ...
        if (res === "REFRESH_SUCCESS") {
            ...
            toast.warning("You have used all your free data for the day, please come back tommorow or upgrade your account");
            openModalConvertUser()
        } else if (res === "ANON") {
            toast.warning("You're account membership is Anonymous please upgrade your account");
            openModalConvertUser()
        }
