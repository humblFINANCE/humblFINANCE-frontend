            ...
            <Card className="w-full max-w-lg p-2" {...props}>
                ...
                <CardBody className="flex flex-col gap-2">
                    ...
                    <CellWrapper>
                        ...
                        <div
                            className="hidden lg:flex w-full flex-wrap items-center justify-end gap-6">
                        ...
                        <div
                            className="lg:hidden flex w-full flex-wrap items-center justify-start mt-4 gap-6">
                            <Button
                                endContent={<Icon icon="hugeicons:setup-01" width={20}/>}
                                radius="full"
                                variant="bordered"
